...
MNIST_PATH = "/project/snoplus/s2cnn/examples/mnist/s2_mnist.gz"
...
def main():
    ...
    optimizer = torch.optim.Adam(
        ...
        lr=LEARNING_RATE)
    print(summary(classifier, (1,60,60)))

    for epoch in range(NUM_EPOCHS):
        for i, (images, labels) in enumerate(train_loader):
            classifier.train()

            # print('imsize', images.size())
        ...
        print('\rEpoch [{0}/{1}], Test Accuracy: {2}'.format(epoch+1, NUM_EPOCHS, 100 * correct / total), end="")
