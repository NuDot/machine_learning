...
def main():
  #python /projectnb/snoplus/machine_learning/network/network_p3.py --signallist /projectnb/snoplus/machine_learning/data/networktrain_v2/Xe136center.dat --bglist /projectnb/snoplus/machine_learning/data/networktrain_v2/C10center.dat --signal Xe136 --bg C10 --outdir /projectnb/snoplus/machine_learning/plots --time_index 6 --qe_index 10
