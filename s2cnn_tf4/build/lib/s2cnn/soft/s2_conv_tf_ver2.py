...
class S2Convolution(Layer):
    ...
    def build(self, input_shape):
        ...
        self.built = True
        super(S2Convolution, self).build(input_shape) 
    ...
    def call(self, x): ##########################################################
        ...
        x = K.cast(x, 'float32')
        x = s2_rfft(x, self.b_out)	# [l * m * n, batch, feature_in]
        y = s2_rft(self.kernel * self.scaling, self.b_out, self.grid)	# [l * m * n, feature_in, feature_out]
